...
class SearchConversation extends Conversation
 {
    ...
    public function start( Nutgram $bot ) {
        $bot->sendMessage(
            text:$this->sesionText,
            reply_markup:InlineKeyboardMarkup::make()
            ->addRow( InlineKeyboardButton::make( 'Web Search', url:$bot::WebAppUrl() ) )
            ->addRow( InlineKeyboardButton::make( 'Telegram Search', switch_inline_query_current_chat:'2023' ) )
        );
        $this->next( 'step1' );
    }
